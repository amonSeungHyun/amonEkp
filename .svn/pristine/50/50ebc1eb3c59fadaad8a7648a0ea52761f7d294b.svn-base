...
//		$(document).on("change","input#between_date",function(){
	...
	function func_psa(){
		...
		frm.action="/personnelAppointment.yolo";
		frm.method="POST";
		frm.submit();
	}
...
<div id="user_detail_content">
	...
	<span><a class="a_people" href="/people.yolo">구성원</a> / ${requestScope.employeeMap.name}</span>
	...
	<div style="display:flex; justify-content: space-between;">
		...
		<div id="right_sidebar">
			...
			<a class="a_side" href="/commute/mycommute.yolo">
			...
			<a class="a_side" href="/leaveSummary.yolo">
			...
			<a class="a_side" href="/admin/payStub.yolo">
