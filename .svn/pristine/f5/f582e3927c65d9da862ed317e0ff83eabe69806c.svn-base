...
<div id="peopleContent">
		...
		<div id="header">
	        <div id="header_title">
	            <a class="a_title" href="/people.yolo"><span class="title">구성원</span></a>
	            <a class="a_title" href="/organization_chart.yolo"><span class="title">조직도</span></a>
	            <c:if test="${sessionScope.loginuser.empno == 9999}">
	            	<a class="current" href="/change_history.yolo"><span class="title">인사 정보 관리</span></a>
	            </c:if>
	        </div>
	        <div id="button_title">
