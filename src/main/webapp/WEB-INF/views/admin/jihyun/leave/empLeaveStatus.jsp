	...
	<table class="table table-bordered table-hover ">
		...
		<tbody>
			<c:forEach items="${leaveStatusList }" var="leaveStatus">
				<tr>
			      <td class="head" data-toggle="tooltip" data-placement="top" title="해당 사원 휴가보기" onclick="javascript:location.href='/leave/specificEmpLeave.yolo?empno=${leaveStatus.empno }&name=${leaveStatus.name }'" >
