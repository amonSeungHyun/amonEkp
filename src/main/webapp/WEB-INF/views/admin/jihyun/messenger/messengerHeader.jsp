...
<div id="messengerHeader" class="border-bottom">
		<span class="headerTitle ml-5" id="rcvmsg" onclick="javascript:location.href='/messenger/receivedMessage.yolo'">받은 메신저</span>
		<span class="headerTitle" id="sndmsg" onclick="javascript:location.href='/messenger/sentMessage.yolo'">보낸 메신저</span>
