...
<script type="text/javascript">
	...
	function goModify() {
          ...
          frm.method = "POST";
          frm.action = "/workflow/modifyEnd.yolo";
          frm.submit();
...
<div style="display: flex; padding-top: 30px; padding-left: 30px; padding-bottom: 40px;]" class="border-bottom">
	 <span ><a class="mylink" href="javascript:location.href='/workflow.yolo'" style="color: #404040; font-size: 23pt; font-weight: bold; padding-right: 20px;"><</a></span>
	 <span style="color:#404040; font-size: 23pt; font-weight: bold;" onclick="javascript:location.href='/workflow.yolo'">수정하기</span>
