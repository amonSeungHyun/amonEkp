...
<c:if test="${not empty currentStepNo.docCurrentStep && not empty fileList}">
...
<c:if test="${not empty currentStepNo.docCurrentStep && empty fileList}">
    <div class="file-area" id="attachArea">
        <div class="filebox">
            <span class="file-text">파일 찾기</span> <!-- 그레이 색상 텍스트 -->
...
<c:if test="${empty currentStepNo.docCurrentStep && empty fileList}">
    <div class="file-area" id="attachArea">
        <div class="filebox">
            <span class="file-text">파일 찾기</span> <!-- 그레이 색상 텍스트 -->
